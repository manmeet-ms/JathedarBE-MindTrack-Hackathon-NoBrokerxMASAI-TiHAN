...
import { TestApplyPoints, applyPoints, createHourlyCheckin, getDiscordUserProfile, getHourlyCheckins, getPointsLedger, getUser, updateUserProfile } from "../controllers/user.controller.js";
...
router.post("/points/apply", applyPoints);
router.get("/points/ledger", getPointsLedger);
router.post("/points/apply/test/:entryLimit", TestApplyPoints);
